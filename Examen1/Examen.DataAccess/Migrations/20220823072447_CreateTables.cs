        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Annio = table.Column<string>(type: "nvarchar(4)", maxLength: 4, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Id_EmpleadoId = table.Column<int>(type: "int", nullable: true),
                    Cedula = table.Column<int>(type: "int", nullable: false),
                    CedulaEmp = table.Column<int>(type: "int", nullable: false),
                    ...
                    Annio = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Precio = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Ventas_Empleados_Id_EmpleadoId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Elemento2", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Elemento2_Ventas_VentasId",
                        column: x => x.VentasId,
                        principalTable: "Ventas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Elemento2_Ventas_VentasId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Elemento3", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Elemento3_Ventas_VentasId",
                        column: x => x.VentasId,
                        principalTable: "Ventas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Elemento2_VentasId",
                table: "Elemento2",
                column: "VentasId");

            migrationBuilder.CreateIndex(
                name: "IX_Elemento2_VentasId1",
                table: "Elemento2",
                column: "VentasId1");

            migrationBuilder.CreateIndex(
                name: "IX_Elemento3_VentasId",
                table: "Elemento3",
                column: "VentasId");
